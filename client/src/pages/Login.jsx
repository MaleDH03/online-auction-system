...
const Login = () => {
  ...
  return (
    <section className="h-screen bg-[#1B1430] flex flex-col md:flex-row">
      {/* Left Section: Image */}
      ...
      <div className="w-full md:w-1/2 h-1/2 md:h-screen flex items-center justify-center px-6 py-8">
        <div className="w-full max-w-xl bg-[#3A2F5F] rounded-lg shadow-lg p-10 space-y-8 md:space-y-12">
          {/* Header with Icons */}
